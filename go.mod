module github.com/jaredallard/vault-issue
...
require (
	...
	// To update, check the tagged value of the sdk (URL):
	// https://github.com/hashicorp/vault/tree/v1.14.2/sdk
	// and use the commit as the version. Then run `go mod tidy`.
